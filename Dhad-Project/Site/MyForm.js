...
let expirationDateIError = false;
 ...
 this.document.querySelector(".myContinueButton").addEventListener("click", () => {
     ...
     <input class="myUserName-input" id="userInput" style="width: 90%" placeholder="ادخل اسمك" /> 
     ...
     <input id="cardNumInput1" class="myUserName-input" style="width: 90%" placeholder="4000 - 1234 - 5678 - 9010" /> 
     ...
     <div style="display: flex; justify-content: space-between;"> 
         <div > 
             ...
             <input id="securityCodeInput" class="myUserName-input" style="width: 85%" type="password" placeholder="******" /> 
         ...
         <div > 
             ...
             <input id="expirationDateInput" class="myUserName-input" style="width: 80%" placeholder=" 2023 / 01 "/> 
